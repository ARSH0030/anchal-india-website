...
const links=[["/about","About"],["/products","Products"],["/brands","Our Brands"],["/brand-network","Brand Network"],["/global-presence","Global Presence"],["/credentials","Credentials"]];
...
export function Footer(){
 return <footer><div className="container footer-top">
  ...
  <div><h4>Markets</h4><Link href="/global-presence">Latin America</Link><Link href="/products">Parts Finder</Link><Link href="/credentials">Credentials</Link></div>
